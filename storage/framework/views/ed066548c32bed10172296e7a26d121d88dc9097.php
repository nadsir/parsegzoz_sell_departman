...
<head>
    ...
    <link href='<?php echo e(asset('datepicker/css/normalize.css')); ?>' rel='stylesheet'/>
    <link href='<?php echo e(asset('datepicker/css/fontawesome/css/font-awesome.min.css')); ?>' rel='stylesheet'/>
    <link href="<?php echo e(asset('datepicker/css/vertical-responsive-menu.min.css')); ?>" rel="stylesheet"/>
    <link href="<?php echo e(asset('datepicker/css/style.css')); ?>" rel="stylesheet"/>
    <link href="<?php echo e(asset('datepicker/css/prism.css')); ?>" rel="stylesheet"/>
    <link rel="stylesheet" href="<?php echo e(asset('datepicker/css/persianDatepicker-default.css')); ?>"/>
    <link rel="stylesheet" href="<?php echo e(asset('datepicker/css/persianDatepicker-latoja.css')); ?>"/>

    <script src="<?php echo e(asset('js/prism.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vertical-responsive-menu.min.js')); ?>"></script>
...
<!-- right side column. contains the logo and sidebar -->
    ...
    <div class="content-wrapper">
        ...
        <form action="/editcustomerorder" method="post">
            <input type="text" name="cid" value="<?php echo e($customerid); ?>" style="display:none;">
            <?php echo csrf_field(); ?>
            <div class="container" style="background-color: #ffffff">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="text" style="display: none" name="factornumber" value="<?php echo e($orderdetail->id); ?>">

                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">قیمت</label>
                                <input name="mount" type="text" class="form-control" id="exampleInputEmail1"
                                       placeholder="قیمت" onkeyup="javascript:this.value=itpro(this.value); "  value=' <?php echo e($orderdetail->mount); ?>'>

                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">درصد تخفیف</label>
                                <input name="discount" type="text" class="form-control" id="exampleInputEmail1"
                                       placeholder="درصد تخفیف" value=' <?php echo e($orderdetail->discount); ?>'>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">پرداخت نقدی</label>
                                <input name="cashpay" type="text" class="form-control" id="exampleInputEmail1"
                                       placeholder="پرداخت نقدی" onkeyup="javascript:this.value=itpro(this.value);" value=' <?php echo e($orderdetail->cashpay); ?>'>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">نام بانک</label>
                                <select name="bank" class="form-control" id="asdas" value=' <?php echo e($orderdetail->bank); ?>'>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select name="announced" class="form-control" id="exampleFormControlSelect1" >
                                    <option value="1" <?php if($orderdetail->announced ==1): ?> selected <?php endif; ?> >اعلام شده</option>
                                    <option value="0" <?php if($orderdetail->announced ==0): ?> selected <?php endif; ?> >اعلام نشده</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="recovery" class="form-control" id="exampleFormControlSelect1" value="0">
                                    <option value="1" <?php if($orderdetail->recovery ==1): ?> selected <?php endif; ?>>وصول شده</option>
                                    <option value="0" <?php if($orderdetail->recovery ==0): ?> selected <?php endif; ?>>وصول نشده</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlSelect1"> وضعیت مالیاتی</label>
                                <select name="tax" class="form-control" id="exampleFormControlSelect1">
                                    <option value="1" <?php if($orderdetail->tax ==1): ?> selected <?php endif; ?>>وصول شده</option>
                                    <option value="0" <?php if($orderdetail->tax ==0): ?> selected <?php endif; ?>>وصول نشده</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value=' <?php echo e($orderdetail->data); ?>'  name="date" type="text" id="pdpF2"  class="form-control pdp-el" data-jdate="1401-01-02" data-gdate="2022-03-22">
                            </div>
...
<script src="<?php echo e(asset('datepicker/js/jquery-1.10.1.min.js')); ?>"></script>
<script src="<?php echo e(asset('datepicker/js/persianDatepicker.js')); ?>"></script>
<script>
    $(function () {
        //usage
...
<!-- AdminLTE App -->
<script src="<?php echo e(asset('admin_panel/admin_panel/dist/js/adminlte.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\sales\Laravel Framework 9.6.0\resources\views/admin_panel/editfactor.blade.php ENDPATH**/ ?>