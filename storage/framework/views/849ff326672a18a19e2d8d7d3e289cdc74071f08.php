...
<head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
          href="<?php echo e(asset('admin_panel/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')); ?>">
    <!-- Theme style -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <h1>تاریخچه خرید آقای <?php echo e($name); ?></h1>
            </h1>
            <br>
            <ol class="breadcrumb">
                <form action="/customerorder/<?php echo e($customerid); ?>" method="get">
                        ...
                        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="col-sm-12">
                                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                                        ...
                                        <tr role="row" class="odd">
                                          ...
                                          ?>
                                              <td><?php echo e($orderdetail->id); ?></td>
                                              <td class="money"><?php echo e($orderdetail->mount); ?></td>

                                              <td><?php echo e($orderdetail->discount); ?> %</td>
                                              <td class="money"><?php echo e($orderdetail->afterdiscount); ?></td>
                                              <td class="money"><?php echo e($orderdetail->cashpay); ?></td>
                                              <td class="money"><?php echo e($orderdetail->aftercash); ?></td>
                                              <td><?php echo e($orderdetail->bank); ?></td>
                                              <?php if($orderdetail->cash== 1): ?>
                                                  <td >پرداخت نقدی</td>
                                              <?php else: ?>
                                                  <td>پرداخت چکی</td>
                                              <?php endif; ?>
                                              <?php if($orderdetail->announced== 1): ?>
                                                  <td >اعلام شده</td>
                                              <?php else: ?>
                                                  <td>اعلام نشده</td>
                                              <?php endif; ?>
                                              <?php if($orderdetail->recovery== 1): ?>
                                                  <td > وصول شده</td>
                                              <?php else: ?>
                                                  <td> وصول نشده</td>
                                              <?php endif; ?>
                                              <td>
                                                  <?php echo e($orderdetail->data); ?>

                                              </td>
                                              <td><?php echo e($orderdetail->time); ?></td>
                                              <td>
                                                  <a href="/editfactor/<?php echo e($orderdetail->id); ?>">
                                                      <button type="button" class="btn btn-warning">  ویرایش فاکتور </button>
                                                  </a>
                                              </td>
                                              <?php if($orderdetail->tax== 1): ?>
                                                  <td  style="background-color: #e5ffb0;border: solid grey 1px"></td>
                                              <?php else: ?>
                                                  <td  style="background-color: #ffd9df;border: solid grey 1px""></td>
                                              <?php endif; ?>
                                        </tr>
                                        <?php if(!$orderdetail->check->isEmpty()): ?>
                                                            ...
                                                            <div class="box col-md-4" >
                                                                ...
                                                                <div class="box-body table-responsive no-padding">
                                                                    <table class="table table-hover">
                                                                        ...
                                                                        <?php $__currentLoopData = $orderdetail->check; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <tr>
                                                                                <td><?php echo e($check->order_id); ?></td>
                                                                                <td class="money"><?php echo e($check->amount_check); ?></td>
                                                                                <td><?php echo e($check->check_number); ?></td>
                                                                                <td><?php echo e($check->date); ?></td>
                                                                                <td>
                                                                                    <form action="/changecheck/<?php echo e($check->id); ?>" method="get">
                                                                                        <button type="submit" class="btn btn-warning">بروز رسانی چک</button>
                                                                                    </form>
                                                                                </td>
                                                                                <td>
                                                                                    <form action="/changestatus/<?php echo e($check->id); ?>" method="get">
                            ...
                            <div class="row col-md-6">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th class="money"><?php echo e($finalallmount); ?></th>
                                        <th class="money"><?php echo e($finalallmount-$allcheck); ?></th>
                                        <td class="money"><?php echo e($finalallmount-$paycheck); ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <form action="/addcheck/<?php echo e($checkid); ?>" method="post">
            <?php echo csrf_field(); ?>
        <div class="container">
...
<?php /**PATH C:\xampp\htdocs\sales\Laravel Framework 9.6.0\resources\views/admin_panel/editorder.blade.php ENDPATH**/ ?>