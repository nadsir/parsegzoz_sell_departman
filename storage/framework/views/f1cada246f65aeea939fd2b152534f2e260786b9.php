...
<!-- right side column. contains the logo and sidebar -->
    ...
    <div class="content-wrapper">
        ...
        <form action="/editcustomercheck" method="post">
            ...
            <div class="container" style="background-color: #ffffff">
                <div class="row">
                    ...
                    <?php $__currentLoopData = $orderdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input name="id" type="text" style="display: none" value="<?php echo e($orderdetail->id); ?>">
                        <div class="col-md-6">
                            <input type="text" style="display: none" name="factornumber" value="<?php echo e($orderdetail->id); ?>">

                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">مبلغ چک</label>
                                    <input name="mount" type="text" class="form-control" id="exampleInputEmail1"
                                           placeholder="قیمت" onkeyup="javascript:this.value=itpro(this.value); "  value=' <?php echo e($orderdetail->amount_check); ?>'>

                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">شماره چک</label>
                                    <input name="discount" type="text" class="form-control" id="exampleInputEmail1"
                                           placeholder="درصد تخفیف" value=' <?php echo e($orderdetail->check_number); ?>'>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value=' <?php echo e($orderdetail->date); ?>'  name="date" type="text" id="pdpF2"  class="form-control pdp-el" data-jdate="1401-01-02" data-gdate="2022-03-22">
                                </div>
...
<?php /**PATH C:\xampp\htdocs\sales\Laravel Framework 9.6.0\resources\views/admin_panel/editcheck.blade.php ENDPATH**/ ?>