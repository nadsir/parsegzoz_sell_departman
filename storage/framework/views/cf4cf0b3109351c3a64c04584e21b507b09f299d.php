        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                                ...
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-right">
                                            <img src="<?php echo e(asset('admin_panel/dist/img/user2-160x160.jpg')); ?>" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            علیرضا
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo e(asset('admin_panel/dist/img/user2-160x160.png')); ?>" class="user-image" alt="User Image">
                        <span class="hidden-xs">واحد فروش</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo e(asset('admin_panel/dist/img/user2-160x160.png')); ?>" class="img-circle" alt="User Image">
...
<?php /**PATH C:\xampp\htdocs\sales\Laravel Framework 9.6.0\resources\views/layouts/admin-header.blade.php ENDPATH**/ ?>