        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('admin_panel/dist/img/user2-160x160.png') }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">واحد فروش</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{ asset('admin_panel/dist/img/user2-160x160.png') }}" class="img-circle" alt="User Image">
