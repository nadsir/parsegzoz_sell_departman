            ...
            <div class="container" style="background-color: #ffffff">
                <div class="row">
                    ...
                    @foreach($orderdetails as $orderdetail)
                        <input name="id" type="text" style="display: none" value="{{$orderdetail->id}}">
                        <div class="col-md-6">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input name="mount" type="text" class="form-control" id="exampleInputEmail1"
                                           placeholder="قیمت" onkeyup="javascript:this.value=itpro(this.value); "  value=' {{$orderdetail->amount_check}}'>

                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">شماره چک</label>
                                    <input name="discount" type="text" class="form-control" id="exampleInputEmail1"
                                           placeholder="درصد تخفیف" value=' {{$orderdetail->check_number}}'>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value=' {{$orderdetail->date}}'  name="date" type="text" id="pdpF2"  class="form-control pdp-el" data-jdate="1401-01-02" data-gdate="2022-03-22">
                                </div>
