                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach ($customerresults as $customerresult)
                                    <tr>
                                        <td>{{$customerresult->id}}</td>
                                        <td>{{$customerresult->name}}</td>
                                        <td>{{$customerresult->lname}}</td>
                                        <td>{{$customerresult->phone}}</td>
                                        <td>{{$customerresult->code}}</td>
                                        <td> <button type="button" class="btn btn-info"> بروز رسانی  </button></td>
                                        <td>
                                            <a href="/customerorder/{{$customerresult->id}}">
